...
CREATE TYPE type_of_device AS ENUM ('light', 'button', 'gas', 'steam', 'humidity', 'buzz', 'servo', 'fan', 'display', 'photo', 'motion', 'temperature', 'tilt', 'brightness', 'door', 'window', 'distance');
